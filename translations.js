...
.`,
        ...
        "rules.respect.text": `La participación en R.E.C Rivals implica el respeto hacia todos los participantes, organizadores y espectadores. No se tolerará ningún comportamiento tóxico. Los insultos, el acoso, las amenazas y cualquier comentario racista, homófobo, tránsfobo, xenófobo o discriminatorio están estrictamente prohibidos.<br>Cualquier actitud contraria al espíritu del evento podrá conllevar una sanción inmediata.<br>Cualquier acción destinada a eludir el espíritu de la competición, aunque no esté explícitamente prohibida en este reglamento, podrá considerarse antideportiva y dar lugar a sanciones.<br>El stream sniping está estrictamente prohibido.<br>Desde el momento en que se conectan al servidor de Rust, los jugadores deben estar obligatoriamente presentes en el canal de voz de su equipo en el Discord de R.E.C Events, y esto durante toda la duración del evento.<br>Al participar en este evento, aceptas que puedas ser filmado/grabado (voz, gameplay) y transmitido en stream y YouTube por la organización. Cualquier solicitud para eliminar un fragmento en el que aparezcas puede hacerse posteriormente.`,
